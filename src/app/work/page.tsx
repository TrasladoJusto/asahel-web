...
export const metadata: Metadata = {
  ...
  description:
    'Portafolio de proyectos: e-commerce con Stripe, dashboards SaaS, plataformas de integración API. Desarrollador web freelance en Lima, Perú.',
  openGraph: {
    title: 'Portafolio | Asahel — Desarrollador Web Lima Perú',
    description:
      'Casos de estudio reales: e-commerce, SaaS, APIs. Código limpio, arquitectura escalable, resultados medibles.',
