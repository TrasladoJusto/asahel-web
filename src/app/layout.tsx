...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'diseño de páginas web Perú', 'Next.js developer Peru', 'full-stack developer Lima',
    'creador de páginas web', 'empresa desarrollo web Perú', 'desarrollador web freelance Lima',
  ],
  ...
  return (
    <html lang="es" className="antialiased">
      <head>
        ...
        <link rel="preload" href="/fonts/HelveticaNowDisplay-Medium.woff2" as="font" type="font/woff2" crossOrigin="anonymous" />
        <link rel="preload" href="/fonts/HelveticaNowDisplay-Regular.woff2" as="font" type="font/woff2" crossOrigin="anonymous" />
