export const caseStudies = [
  {
    ...
    featured: true,
    problem: 'Necesidad de migrar de WooCommerce a una solución headless que soportara múltiples vendedores, comisiones automáticas y escalabilidad a 10k+ productos.',
  ...
  },
  {
    ...
    featured: false,
    problem: 'Necesidad de dashboard para equipos remotos con colaboración en tiempo real, kanban, gantt y métricas de productividad.',
