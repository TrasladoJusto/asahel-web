      ...
      <div className="section-container">
        ...
        <div className="mt-24">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
            {[
              ["¿Cuánto cuesta una página web?", "Depende del alcance: una landing profesional parte de S/1,400; sitios corporativos desde S/3,200; e-commerce desde S/5,500. Siempre recibes presupuesto cerrado por escrito antes de empezar, sin sorpresas."],
              ["¿Cuánto demora un proyecto?", "Una landing: 7 días. Sitio corporativo: 2 a 3 semanas. E-commerce o SaaS: 4 a 8 semanas. Trabajo con entregas parciales semanales para que veas avances reales desde el día uno."],
              ["¿La web es mía? ¿Qué pasa si dejas de trabajar conmigo?", "El código, el dominio y todo el contenido son 100% tuyos desde el primer pago. Recibes el repositorio completo y documentación; puedes migrarlo con cualquier desarrollador cuando quieras."],
              ["¿Por qué Next.js y no WordPress?", "Next.js carga en menos de 1 segundo, escala sin plugins de terceros y es más seguro al no depender de CMS vulnerables. WordPress lo uso solo cuando el proyecto realmente lo necesita."],
            ].map(([q, a], i) => (
